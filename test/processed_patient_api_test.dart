...
/// tests for ProcessedPatientApi
void main() {
  // final instance = ProcessedPatientApi();

  group('tests for ProcessedPatientApi', () {
    ...
    test('test createProcessedPatientEntryApiV1ProcessedPatientPost', () async {
      // TODO
    });
    ...
    test('test readProcessedPatientEntriesApiV1ProcessedPatientYearMonthGet', () async {
      // TODO
    });
