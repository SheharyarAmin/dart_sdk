...
part 'model/e2_e_encrypted_message.dart';
part 'model/e2_e_encryption_config.dart';
...
part 'model/rpm_patient_data.dart';
part 'model/rpm_patients_response.dart';
