...
class CCMPatientCreate {
  ...
  @override
  String toString() => 'CCMPatientCreate[clinicid=$clinicid, providerid=$providerid, employeeid=$employeeid, finnumber=$finnumber, mrnnumber=$mrnnumber, iv=$iv, lastprocessed=$lastprocessed, optindate=$optindate, optoutdate=$optoutdate]';
