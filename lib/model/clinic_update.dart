...
class ClinicUpdate {
  ...
  @override
  String toString() => 'ClinicUpdate[customerId=$customerId, clinicName=$clinicName, consultantid=$consultantid, address=$address, poc=$poc, phone=$phone, email=$email, fax=$fax, region=$region, canBeDeleted=$canBeDeleted, status=$status]';
