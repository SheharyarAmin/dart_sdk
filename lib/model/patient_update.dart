...
class PatientUpdate {
  ...
  @override
  String toString() => 'PatientUpdate[patientname=$patientname, payername=$payername, secandarypayername=$secandarypayername, address=$address, dob=$dob, primaryphone=$primaryphone, secondaryphone=$secondaryphone, deceased=$deceased, region=$region, iv=$iv, ccmDetail=$ccmDetail, pcmDetail=$pcmDetail]';
