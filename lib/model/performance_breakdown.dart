...
class PerformanceBreakdown {
  /// Returns a new [PerformanceBreakdown] instance.
  ...
  /// Returns a new [PerformanceBreakdown] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static PerformanceBreakdown? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "PerformanceBreakdown[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "PerformanceBreakdown[$key]" has a null value in JSON.');
        });
        return true;
      }());
  ...
  static List<PerformanceBreakdown> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <PerformanceBreakdown>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = PerformanceBreakdown.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, PerformanceBreakdown> mapFromJson(dynamic json) {
    final map = <String, PerformanceBreakdown>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = PerformanceBreakdown.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of PerformanceBreakdown-objects as value to a dart map
  static Map<String, List<PerformanceBreakdown>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<PerformanceBreakdown>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = PerformanceBreakdown.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
