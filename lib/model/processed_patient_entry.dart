...
class ProcessedPatientEntry {
  ...
  @override
  String toString() => 'ProcessedPatientEntry[patientId=$patientId, patientName=$patientName, finNumber=$finNumber, mrnNumber=$mrnNumber, processedDate=$processedDate, action=$action, empid=$empid, year=$year, month=$month, day=$day, portal=$portal, paycode99426=$paycode99426, paycode99427=$paycode99427, paycode1=$paycode1, paycode2=$paycode2, paycode12=$paycode12, clinicid=$clinicid, clinincName=$clinincName, providerid=$providerid, providerName=$providerName, hospitalRehabStatus=$hospitalRehabStatus, unableToProcess=$unableToProcess, carePlanStatus=$carePlanStatus, inCompleteCarePlanStatus=$inCompleteCarePlanStatus, remarks=$remarks, timestamp=$timestamp, currentTime=$currentTime, id=$id]';
