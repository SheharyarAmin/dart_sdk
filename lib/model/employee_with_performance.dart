...
class EmployeeWithPerformance {
  /// Returns a new [EmployeeWithPerformance] instance.
  EmployeeWithPerformance({
    ...
    this.performanceStatus = 'no_data',
  ...
  EmployeePerformanceSummary? performanceSummary;
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is EmployeeWithPerformance &&
    other.name == name &&
    other.role == role &&
    other.portal == portal &&
    other.region == region &&
  ...
  Map<String, dynamic> toJson() {
    ...
    if (this.performanceSummary != null) {
      json[r'performance_summary'] = this.performanceSummary;
    } else {
      json[r'performance_summary'] = null;
    }
  ...
  /// Returns a new [EmployeeWithPerformance] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static EmployeeWithPerformance? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "EmployeeWithPerformance[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "EmployeeWithPerformance[$key]" has a null value in JSON.');
        });
        return true;
      }());
      ...
      return EmployeeWithPerformance(
        ...
        performanceStatus: mapValueOfType<String>(json, r'performance_status') ?? 'no_data',
        workloadStatus: mapValueOfType<String>(json, r'workload_status') ?? 'unknown',
      );
    }
    return null;
  }

  static List<EmployeeWithPerformance> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <EmployeeWithPerformance>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = EmployeeWithPerformance.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, EmployeeWithPerformance> mapFromJson(dynamic json) {
    final map = <String, EmployeeWithPerformance>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = EmployeeWithPerformance.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of EmployeeWithPerformance-objects as value to a dart map
  static Map<String, List<EmployeeWithPerformance>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<EmployeeWithPerformance>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = EmployeeWithPerformance.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
