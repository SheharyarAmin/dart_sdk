...
class CareManagementCallCreate {
  ...
  bool operator ==(Object other) =>
      ...
      other is CareManagementCallCreate &&
          other.iv == iv &&
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key),
              'Required key "CareManagementCallCreate[$key]" is missing from JSON.');
          assert(json[key] != null,
              'Required key "CareManagementCallCreate[$key]" has a null value in JSON.');
        });
        return true;
      }());
  ...
  static List<CareManagementCallCreate> listFromJson(
    dynamic json, {
    bool growable = false,
  }) {
  ...
  static Map<String, List<CareManagementCallCreate>> mapListFromJson(
    dynamic json, {
    bool growable = false,
  }) {
    ...
    if (json is Map && json.isNotEmpty) {
      ...
      for (final entry in json.entries) {
        map[entry.key] = CareManagementCallCreate.listFromJson(
          entry.value,
          growable: growable,
        );
      }
