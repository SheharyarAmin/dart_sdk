...
class EmployeeCreate {
  ...
  @override
  String toString() => 'EmployeeCreate[name=$name, address=$address, email=$email, role=$role, region=$region, payPerCCM=$payPerCCM, payPerHour=$payPerHour, patientsPerMonth=$patientsPerMonth, assignedPatients=$assignedPatients, canBeDeleted=$canBeDeleted, status=$status]';
